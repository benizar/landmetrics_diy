...
{
    /// <summary>
    /// This class calculates the largest patch size at the class level. Units: meters
    /// </summary>
    public class C_LargestPatchSize_V
    {

         /// <summary>
        /// Calculates the largest patch size at the class level
        /// </summary>
        ...
        public C_LargestPatchSize_V(string filename, string epsg, int fieldIndex)
        {
        ...
        DataTable _cLargestPatchSize_V = new DataTable("C_LargestPatchSize_V");
        ...
        /// <summary>
        /// Gets a list of class names and largest patch size per category. Units: meters
        /// </summary>
        public DataTable C_Names_LargestPatchSize_V
        {
            get { return _cLargestPatchSize_V; }
        }
        ...
        private void categoryMetrics(string filename, string epsg, int fieldIndex)
        {
            try
            {
                ...
                for (int i = 0; i < categories.Count; i++)
                {
                    ...
                    //en cada iteración j obtenemos el área mayor de esa categoria
                ...
                _cLargestPatchSize_V.Columns.Add("CategoryName", typeof(string));
                _cLargestPatchSize_V.Columns.Add("LargestPatchSize", typeof(double));

                for (int i = 0; i < _categoryNames.Count; i++)
                {
                    _cLargestPatchSize_V.Rows.Add(_categoryNames[i], _largestPatchSizePerCategory[i]);
                }
