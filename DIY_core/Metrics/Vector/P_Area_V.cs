...
{
    /// <summary>
    /// This class calculates the area at the patch level --(AREA_p)-- Units: meters
    /// </summary>
    public class P_Area_V
    {

        /// <summary>
        /// Calculates area at the patch level --(AREA_p)-- Units: meters
        /// </summary>
        ...
        public P_Area_V(string filename, string epsg, int fieldIndex)
        {
        ...
        DataTable _pArea_V = new DataTable("P_Area_V");
        ...
        /// <summary>
        /// Gets a list of patch names and areas --(AREA_p)-- Units: meters
        /// </summary>
        public DataTable P_Names_Areas_V
        {
            get { return _pArea_V; }
        }
